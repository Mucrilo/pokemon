...
CREATE TABLE IF NOT EXISTS `mydb`.`Atributos` (
  `idAtributos` INT GENERATED ALWAYS AS (),
  `Vida` INT NOT NULL,
  `Ataque` INT NOT NULL,
  `Defesa` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`Pokemon_has_Atributos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Pokemon_has_Atributos` (
  `Pokemon_idPokemon` INT NOT NULL,
  `Atributos_idAtributos` INT NOT NULL,
  PRIMARY KEY (`Pokemon_idPokemon`, `Atributos_idAtributos`),
  INDEX `fk_Pokemon_has_Atributos_Atributos1_idx` (`Atributos_idAtributos` ASC) VISIBLE,
  INDEX `fk_Pokemon_has_Atributos_Pokemon1_idx` (`Pokemon_idPokemon` ASC) VISIBLE,
  CONSTRAINT `fk_Pokemon_has_Atributos_Pokemon1`
    FOREIGN KEY (`Pokemon_idPokemon`)
    REFERENCES `mydb`.`Pokemon` (`idPokemon`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Pokemon_has_Atributos_Atributos1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`Pokebola` (
  ...
  PRIMARY KEY (`idPokebola`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `mydb`.`Treinador_has_Pokebola`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Treinador_has_Pokebola` (
  `Treinador_idTreinador` INT NOT NULL,
  `Pokebola_idPokebola` INT NOT NULL,
  PRIMARY KEY (`Treinador_idTreinador`, `Pokebola_idPokebola`),
  INDEX `fk_Treinador_has_Pokebola_Pokebola1_idx` (`Pokebola_idPokebola` ASC) VISIBLE,
  INDEX `fk_Treinador_has_Pokebola_Treinador1_idx` (`Treinador_idTreinador` ASC) VISIBLE,
  CONSTRAINT `fk_Treinador_has_Pokebola_Treinador1`
    FOREIGN KEY (`Treinador_idTreinador`)
    REFERENCES `mydb`.`Treinador` (`idTreinador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Treinador_has_Pokebola_Pokebola1`
    FOREIGN KEY (`Pokebola_idPokebola`)
    REFERENCES `mydb`.`Pokebola` (`idPokebola`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`Pokebola_has_Pokemon`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Pokebola_has_Pokemon` (
  `Pokebola_idPokebola` INT NOT NULL,
  `Pokemon_idPokemon` INT NOT NULL,
  PRIMARY KEY (`Pokebola_idPokebola`, `Pokemon_idPokemon`),
  INDEX `fk_Pokebola_has_Pokemon_Pokemon1_idx` (`Pokemon_idPokemon` ASC) VISIBLE,
  INDEX `fk_Pokebola_has_Pokemon_Pokebola1_idx` (`Pokebola_idPokebola` ASC) VISIBLE,
  CONSTRAINT `fk_Pokebola_has_Pokemon_Pokebola1`
    FOREIGN KEY (`Pokebola_idPokebola`)
    REFERENCES `mydb`.`Pokebola` (`idPokebola`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Pokebola_has_Pokemon_Pokemon1`
    FOREIGN KEY (`Pokemon_idPokemon`)
    REFERENCES `mydb`.`Pokemon` (`idPokemon`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
